...
// It implements repository.Repository interface in order to have business operation
// for our counter component.
//
// NOTE: ClickHouse does not fit as a counter store but the main purpose of
// this repository is to explore different kind of SGBD and setup testcontainers
