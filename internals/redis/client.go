// redis package define a client to send request to a Redis server.
// It implements repository.Repository interface in order to run
// business logic related to our counter component.
package redis
